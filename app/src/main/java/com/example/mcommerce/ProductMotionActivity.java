...
public class ProductMotionActivity extends BaseActivity implements ProductGridAdapter.OnProductItemClickListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_product_motion);
            ...
            public void onResponse(Call<ResProducts> call, Response<ResProducts> response) {
                ...
                if (result != null){
                    if (result.errorCode == 0){
                        ...
                        mTextRight.setText(GlobalConst.total_point);
    ...
    public void onProductItemClicked(int pos) {
        ...
        intent.putExtra(ProductsActivity.PRODUCT_ITEM, product);
